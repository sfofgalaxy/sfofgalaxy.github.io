...
redirect_from:
  - /teaching/
show_title: false
excerpt: "Teaching, service, education, and professional experience."
---

<section class="page-heading">
  <p class="section-kicker">{% include icon.html name="work" %}<span>Experience</span></p>
  <h1>Teaching, service, education, and professional work</h1>
  <p>This page keeps the former Teaching & Service content, now merged with the broader experience timeline.</p>
</section>

<section class="experience-grid standalone-experience">
